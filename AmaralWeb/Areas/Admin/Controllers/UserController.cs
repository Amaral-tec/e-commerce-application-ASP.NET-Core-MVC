...
namespace AmaralWeb.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public IActionResult RoleManagment(RoleManagmentVM roleManagmentVM)
        {
            ...
            {
                if (roleManagmentVM.ApplicationUser.Role == StaticData.ROLE_COMPANY)
                {
            ...
            {
                if (oldRole == StaticData.ROLE_COMPANY && applicationUser.CompanyId != roleManagmentVM.ApplicationUser.CompanyId)
                {
                    applicationUser.CompanyId = roleManagmentVM.ApplicationUser.CompanyId;
                    _unitOfWork.ApplicationUser.Update(applicationUser);
                    _unitOfWork.Save();
