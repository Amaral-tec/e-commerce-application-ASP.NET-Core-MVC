...
namespace Amaral.DataAccess.Migrations
{
    ...
    [Migration("20240728023704_addProductImageToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Amaral.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Amaral.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Amaral.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Amaral.Models.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Amaral.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Amaral.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Amaral.Models.OrderDetail", b =>
                {
                    b.HasOne("Amaral.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Amaral.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Amaral.Models.OrderHeader", b =>
                {
                    b.HasOne("Amaral.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Amaral.Models.Product", b =>
                {
                    b.HasOne("Amaral.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Amaral.Models.ApplicationUser", b =>
                {
                    b.HasOne("Amaral.Models.Company", "Company")
                        .WithMany()
